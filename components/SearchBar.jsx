      ...
      <form onSubmit={handleSearch} className="relative">
        <div className="relative">
          <input
            ...
            className="w-full pl-12 pr-10 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm"
          />
